...
def conversion(eventdate,titre,lieu,description, jour_entier):
    ...
    if jour_entier :
        for ki in range( len(eventdate)//2):
            ...
            #Ajouter le Json adapté au jour entier
            print()
...
def recup_creneau(key,nom_utilisateur, participant_key):
    ...
    #On récupère la date actuelle en format adapté aux dates du Doodle ; 'Z' indique le temps UTC
